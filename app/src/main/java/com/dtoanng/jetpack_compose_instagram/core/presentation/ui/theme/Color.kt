package com.dtoanng.jetpack_compose_instagram.core.presentation.ui.theme
...
val LineGrayColor = Color.Gray.copy(alpha = 0.25f)
val LineBlueColor = Color.Blue.copy(alpha = 0.25f)